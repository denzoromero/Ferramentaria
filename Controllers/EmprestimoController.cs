...
namespace FerramentariaTest.Controllers
{
    ...
    public class EmprestimoController : Controller
    {
        ...
        public ActionResult SearchSolicitante(string? IdSolicitante)
        {
            ...
            List<FuncionarioViewModel> listEmployeeResult = new List<FuncionarioViewModel>(); //Employee Employee Result
            List<FuncionarioViewModel> listTerceiroResult = new List<FuncionarioViewModel>(); //Third Party Employees Result
            List<FuncionarioViewModel> TotalResult = new List<FuncionarioViewModel>(); //Employee and Third Party Employees Result
            ...
            if (IdSolicitante != null)
            {
                ...
                //Searching using the Employees then adding it to listEmployeeResult then add to TotalResult
