...
namespace FerramentariaTest.Controllers
{
    public class FerramentariasController : Controller
    {
                    ...
                    if (checkPermission != null)
                    {
                        if (checkPermission.Visualizar == 1)
                        {
                            ...
                            if (ferramentarias.Any())
                            {
                                ...
                                int pageNumber = 1;
                                IPagedList<FerramentariaViewModel> FerramentariaPagedList = FerramentariaResult.ToPagedList(pageNumber, pageSize);
        ...
        public ActionResult TestPage(int? page)
        {
            ...
            IPagedList<FerramentariaViewModel> FerramentariaPagedList = _ListFerramentaria.ToPagedList(pageNumber, pageSize);
